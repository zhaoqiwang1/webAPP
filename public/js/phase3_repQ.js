  ...
  phase3RepQGridsDiv.innerHTML = `
    ...
    <div class="grid-item1">
        ...
        <div class="question-block">
          ...
          <label for="P3T1Q1_Rep-arg1">观点1</label>
          <input type="radio" id="P3T1Q1_Rep-arg2" name="P3T1Q1_Rep" value="arg2">
          <label for="P3T1Q1_Rep-arg2">观点2</label>
          <br>
          <p>请给这两个观点的内容质量打分</p>
          <div class="Q2Q3-container">
            <div>
              <label for="P3T1Q2_Rep">观点1:</label>
              <select name="P3T1Q2_Rep" id="P3T1Q2_Rep" required>
                <option value="">--</option>
            ...
            <div>
              <label for="P3T1Q3_Rep">观点2:</label>
              <select name="P3T1Q3_Rep" id="P3T1Q3_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
    ...
    <div class="grid-item2">
        ...
        <div class="left-align-block">
         ...
         <div class="question-block">
          ...
          <label for="P3T2Q1_Rep-arg1">观点1</label>
          <input type="radio" id="P3T2Q1_Rep-arg2" name="P3T2Q1_Rep" value="arg2">
          <label for="P3T2Q1_Rep-arg2">观点2</label>
          <br>
          <p>请给这两个观点的内容质量打分</p>
          <div class="Q2Q3-container">
            <div>
              <label for="P3T2Q2_Rep">观点1:</label>
              <select name="P3T2Q2_Rep" id="P3T2Q2_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <div>
              <label for="P3T2Q3_Rep">观点2:</label>
              <select name="P3T2Q3_Rep" id="P3T2Q3_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
    ...
    <div class="grid-item3">
        ...
        <div class="question-block">
          ...
          <label for="P3T3Q1_Rep-arg1">观点1</label>
          <input type="radio" id="P3T3Q1_Rep-arg2" name="P3T3Q1_Rep" value="arg2">
          <label for="P3T3Q1_Rep-arg2">观点2</label>
          <br>
          <p>请给这两个观点的内容质量打分</p>
          <div class="Q2Q3-container">
            <div>
              <label for="P3T3Q2_Rep">观点1:</label>
              <select name="P3T3Q2_Rep" id="P3T3Q2_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <div>
              <label for="P3T3Q3_Rep">观点2:</label>
              <select name="P3T3Q3_Rep" id="P3T3Q3_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
    ...
    <div class="grid-item4">
        ...
        <div class="question-block">
          ...
          <label for="P3T4Q1_Rep-arg1">观点1</label>
          <input type="radio" id="P3T4Q1_Rep-arg2" name="P3T4Q1_Rep" value="arg2">
          <label for="P3T4Q1_Rep-arg2">观点2</label>
          <br>
          <p>请给这两个观点的内容质量打分</p>
          <div class="Q2Q3-container">
            <div>
              <label for="P3T4Q2_Rep">观点1:</label>
              <select name="P3T4Q2_Rep" id="P3T4Q2_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <div>
              <label for="P3T4Q3_Rep">观点2:</label>
              <select name="P3T4Q3_Rep" id="P3T4Q3_Rep" required>
                <option value="">--</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
